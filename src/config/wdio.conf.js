require('dotenv').config(); // to get a variable use process.env.VARIABLE_NAME
...
const config = {
    ...
    launch: `${process.env.LAUNCH}: ${yargs.browser}`,
    mode: 'DEFAULT',
    debug: false,
...
exports.config = {
    ...
    cucumberOpts: {
        ...
        tagExpression: yargs.tags || '@smoke',
     ...
     */
	 afterStep: async function (step, scenario, result, error) {
		logger.log('info', `${step.id}::${scenario.name}\n\t${step.text}\n\t`, result, '\n');

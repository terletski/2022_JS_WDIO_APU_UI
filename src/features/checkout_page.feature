...
Background: Login standart user and add product to cart
...
Scenario: I checkout information
    When  I enter 'Vitaly' in 'Username field' input on 'Checkout information' page 
